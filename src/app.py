...
activities = {
    ...
    "Basketball Club": {
        "description": "Learn basketball skills, drills, and team play",
        "schedule": "Mondays and Wednesdays, 4:30 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["harry@mergington.edu", "maya@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        "description": "Rehearse and perform stage plays and improv exercises",
    ...
    "Science Olympiad": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["zoey@mergington.edu", "mason@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking, research, and structured debates",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["sara@mergington.edu", "owen@mergington.edu"]
    }
}
